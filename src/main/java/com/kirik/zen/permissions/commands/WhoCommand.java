...
import com.kirik.zen.core.util.PlayerFindException;
...
public class WhoCommand extends ICommand {
	...
	public void run(final CommandSender commandSender, String[] args, String argStr, String commandName) throws PlayerFindException {
		...
		if(commandSender.hasPermission("zen.who.position") && playerLevel >= playerHelper.getPlayerLevel(target)){
		...
		if(commandSender.hasPermission("zen.who.address") && playerLevel >= playerHelper.getPlayerLevel(target) && target.isOnline()){
